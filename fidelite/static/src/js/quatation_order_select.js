odoo.define("fidelite.QuotationOrderSelect", function(require){
     'use strict';
     ...
     const QuotationOrderSelect = SaleOrderManagementScreen =>
                ...
                async _onClickSaleOrder(event) {
                    ...
                    if(confirmed){
                      ...
                      if (selectedOption){
                        ...
                        // ajoute des points de fidelités
                        this.add_point();
                      }
                      else {
                        // apply a downpayment
     ...
     Registries.Component.extend(SaleOrderManagementScreen, QuotationOrderSelect);
});